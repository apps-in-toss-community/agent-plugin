...
// 얹히면 `ait:<basename>` 이 된다 — 2026-07-27 실측(#226). skill 도 같은 목록에 자기
// 디렉토리 이름으로 오른다. `"ait new"` 같은 다단어 키는 어느 형상에도 존재하지 않는다.
//
...
// 픽스처가 옛 basename 을 들고 있으면 개명 회귀를 못 잡으므로 현재 키로 고정한다.
describe('exposesKey', () => {
